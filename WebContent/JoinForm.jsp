		...
		<div class="hero-container">
			...
			<form action="memberJoin" method="POST">
				<table>
					<tr>
						<th>아이디</th>
						<td><input type="text" name="id" maxlength="20" required autocomplete="off" id="userid" ></td>
						<td><input type="button" id="idcheck" value="중복확인" required></td>
					</tr>
					...
					<tr>
						...
						<td><input type="text" name="nick" maxlength="20" id="usernick"
							placeholder="닉네임을 입력해주세요." autocomplete="off" required>
					...
					<tr>
						<th id="title">생년월일</th>
						<td><input type="date" name="birthyy" required></td>
					</tr>
					...
					<tr>
						<th>주소</th>
						<td><input type="text" name="add" size="30" id="sample6_postcode" placeholder="우편번호"> 
							<input type="button" onclick="sample6_execDaumPostcode()" value="우편번호 찾기"> 
							<input type="text" name="add2" size="30" id="sample6_address" placeholder="주소">
							<input type="text" name="add3"size="30" id="sample6_detailAddress" placeholder="상세주소">
            ...
            oncomplete: function(data) {
                ...
                document.getElementById("sample6_detailAddress").focus();
					...
					<tr>
						...
						<button type="submit">가입하기</button></td>
					</tr>
