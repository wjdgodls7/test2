...
<body>
	...
	<section id="hero">
		...
		<div class="hero-container">
			...
			<h1 style="font-size: 35px; font-weight: bold; text-align:center; margin-left:auto; margin-right:auto;" >글 수정하기</h1>
			<form action="writeModify?num=${bNum}" method="POST" enctype="multipart/form-data">
