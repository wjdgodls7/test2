	...
	<header id="header" style="padding: auto;">
		<div class="container-fluid">
			...
			<div class="contact-link float-right">
				<a href="memberLogin" class="scrollto"
	...
	<section id="hero">
		<div class="hero-container" style="padding: 0 50px;">
				...
				<table>
					<thead>
						<tr>
							...
							<option value="all2" selected >조회</option>
							<option value="max">조회 순</option>
							</select>
							</form>
							</th>
			...
			<c:if test="${paging.page>1}">
				<a href="searchKeyword?page=${paging.page-1}&search=${search}">[이전]</a>&nbsp; &nbsp; &nbsp;
			</c:if>
			...
			<c:forEach begin="${paging.startPage}" end="${paging.endPage}" var="i" step="1">
				...
				<c:choose>
					...
					<c:otherwise>
						<a href="searchKeyword?page=${i}&search=${search}">${i}</a>
			...
			&nbsp; &nbsp; &nbsp;<a href="searchKeyword?page=${paging.page+1}&search=${search}">[다음]</a> 
			</c:if>
			</th>
