	...
	<section id="hero">
		<div class="hero-container" style="padding: 0 50px;">
			...
			<c:if test="${paging.page>1}">
				<a href="BoardHitController?page=${paging.page-1}&hit=${hit2}">[이전]</a>&nbsp; &nbsp; &nbsp;
			</c:if>
			...
			<c:forEach begin="${paging.startPage}" end="${paging.endPage}"
				...
				${i}
					...
					<c:otherwise>
						<a href="BoardHitController?page=${i}&hit=${hit2}">${i}</a>
			...
			&nbsp; &nbsp; &nbsp;<a href="BoardHitController?page=${paging.page+1}&hit=${hit2}">[다음]</a>
			</c:if>
			</th>
		</tr>
		<tr>
