	...
	<section id="hero">
		<div class="hero-container" style="padding: 0 50px;">
				...
				<table>
					<thead>
						<tr>
							...
							<option value="all" selected >최신순</option>
			...
			<c:if test="${paging.page>1}">
				<a href="BoardHitCategoryController?page=${paging.page-1}&hit=${hit2}&subject=${subject}">[이전]</a>&nbsp; &nbsp; &nbsp;
			</c:if>
			...
			<c:forEach begin="${paging.startPage}" end="${paging.endPage}"
				...
				${i}
					...
					<c:otherwise>
						<a href="BoardHitCategoryController?page=${i}&hit=${hit2}&subject=${subject}">${i}</a>
			...
			&nbsp; &nbsp; &nbsp;<a href="BoardHitCategoryController?page=${paging.page+1}&hit=${hit2}&subject=${subject}">[다음]</a>
			</c:if>
			</th>
		</tr>
		<tr>
